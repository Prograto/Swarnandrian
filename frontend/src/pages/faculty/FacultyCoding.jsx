...
export default function FacultyCoding() {
  ...
  const bulkUploadModeNote = mode === 'practice'
    ? 'Practice mode uses editorial after Accepted; marks are ignored.'
    : 'Competitor mode uses marks for scoring; editorial is ignored.';
