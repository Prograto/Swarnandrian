...
export const FACULTY_NAV = [
  ...
  { label:'Blogs', href:'/faculty/blogs', icon:<ArticleRoundedIcon sx={{ fontSize: 18 }}/> },
  { label:'Courses', href:'/faculty/courses', icon:<MenuBookRoundedIcon sx={{ fontSize: 18 }}/> },
];
            ...
            {(data?.recent_activity || []).length === 0 ? (
              ...
              <div key={idx} className="flex items-center justify-between rounded-xl border border-theme bg-surface p-3">
                <div>
                  ...
                  <p className="text-xs text-secondary">Score: {item.score ?? 0}</p>
